...
<img src="http://127.0.0.1:8000/biostore_docs/img/connect_to_server.png" alt="Connect to server" width="500" />
...
<img src="http://127.0.0.1:8000/biostore_docs/img/select_volumes.png" alt="Select BioStore volume" width="500" />
...
<img src="http://127.0.0.1:8000/biostore_docs/img/connect_to_server_corefs.png" alt="Connect to server without selecting volume" width="500" />
...
<img src="http://127.0.0.1:8000/biostore_docs/img/username_and_password_mac.png" alt="Enter username and password" width="500" />
...
<img src="http://127.0.0.1:8000/biostore_docs/img/biostore_from_finder.png" alt="Biostore in Finder" width="700" />
